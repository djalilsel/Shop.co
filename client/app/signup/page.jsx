            ...
            <div className='xl:border-2 py-6 px-16 flex flex-col gap-9 items-center'>
                ...
                <div className='flex flex-col w-full satoshi-400'>
                    <div className='relative w-full'>
                        ...
                        <span className='absolute top-3 left-3 text-sm'>Full name</span>
                    </div>
                    <div className='relative w-full'>
                    ...
                    <div className='relative w-full'>
                        <input name='email' type="email" value={input.email} onChange={handleChange} className='border p-3 pt-8 w-full text-[#00000080]' />
                        <span className='absolute top-3 left-3 text-sm'>Email</span>
                    </div>
                </div>
