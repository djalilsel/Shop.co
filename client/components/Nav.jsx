    ...
    return (
        <div className='flex flex-col '>
            <div id='signUp' className='px-4 sm:px-32 bg-darkblack text-[0.75rem] sm:text-[0.875rem] h-[2.375rem] w-full flex justify-center items-center text-basewhite '>
                ...
                <div className='hidden sm:inline sm:absolute right-32 text-[1rem] cursor-pointer' onClick={() => document.querySelector('#signUp').style.display = "none"}>X</div>
            </div>
            <div className='h-20 sm:h-24 sm:px-32 px-4 w-full bg-basewhite flex gap-8 items-center boder-2 border-black'>
                ...
                <span className='integral sm:text-[2rem] text-2xl'>
                    SHOP.CO
                </span>
                <nav className='hidden lg:flex justify-center items-center gap-8 satoshi-400'>
                    <span>
                        Shop
                    </span>
                    <span>
                ...
                <div className='hidden sm:flex relative flex-1'>
                    <input type="text" placeholder='Search for products...' 
                        className='satoshi w-full bg-[#F0F0F0] pl-[2.25rem] p-[0.75rem] rounded-[3.875rem]'
                    />
